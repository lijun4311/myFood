...
@AllArgsConstructor
public class NotifyController implements ILogBase {
...
//			System.out.println("================================= 支付成功 =================================");
            ...
            log.info("************* 支付成功(微信支付异步通知) - 时间: {} *************", LocalDateTime.now());
...
//			valueStr = new String(valueStr.getBytes("ISO-8859-1"), "utf-8");
        ...
        if (signVerified) {//验证成功
            ...
            if (trade_status.equals("TRADE_SUCCESS")) {
                String merchantReturnUrl = paymentOrderService.updateOrderPaid(out_trade_no, Integer.valueOf(total_amount));
